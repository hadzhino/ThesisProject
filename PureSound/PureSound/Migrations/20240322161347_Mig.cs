    ...
    public partial class Mig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0328d65b-e8e6-4e0b-9d8a-f2dec16e0d1b"), "Phonk" },
                    { new Guid("0452eebe-7551-41a0-96ce-a512190c1e7e"), "House" },
                    { new Guid("48d67181-5732-47a0-892b-6577fc688e00"), "None" },
                    { new Guid("4cc9fd7d-54a0-4d1a-a141-c8cb53d17b96"), "R&B" },
                    { new Guid("5f78d27a-7b20-490d-aba2-0e11567e7c9c"), "Techno" },
                    { new Guid("6c9542b1-a92c-4890-995c-52fa7a564f57"), "Rap" },
                    { new Guid("f006b276-c46c-4a9b-8564-48e4bb0b624d"), "Raeggeton" },
                    { new Guid("fd631f59-f404-4405-bbbd-6cc1356fe8c8"), "Drill" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("02f79158-9c29-4004-8311-21b9ffc7e5b7"), "Latin America" },
                    { new Guid("1e1ef110-4dca-40d3-bee0-3af24fecfc42"), "Balkans (EUROPE)" },
                    { new Guid("25f8227f-d677-4550-b919-16689b91df2b"), "Africa" },
                    { new Guid("31b43aae-d9db-41e3-900e-58409c3ec3a9"), "West Europe" },
                    { new Guid("4021a623-011f-4134-a6db-5a63f1823864"), "West Asia" },
                    { new Guid("58afc179-dbaa-46fa-8b19-d8d0823586f3"), "East Europe" },
                    { new Guid("6bd44e28-d276-4771-a145-a36ac71ac033"), "West Coast (NORTH AMERICA)" },
                    { new Guid("6fb2421e-6e33-4375-9168-b1ce36fd36f6"), "Oceania" },
                    { new Guid("75ce4605-bc0b-49eb-b9a0-67044f10a9bd"), "East Coast (NORTH AMERICA)" },
                    { new Guid("7ee5e286-d0a0-43e2-b9e9-2c4c2c9e7f74"), "South America" },
                    { new Guid("bec4b45d-2fbf-452d-9577-db7a1601715b"), "Middle Asia" },
                    { new Guid("c27527a9-5e86-4b17-b8dc-3fa1051702eb"), "East Asia" },
                    { new Guid("d9e70643-d6c2-449a-aa90-263d5e4c2e2a"), "Middle East (ASIA)" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "389e650a-775f-4d7b-a9ac-30cfd960fa37", 0, "1a234d62-476d-4356-8760-07b6ec98dd77", "etaleksander411@gmail.com", false, new Guid("48d67181-5732-47a0-892b-6577fc688e00"), false, null, "ETALEKSANDER411@GMAIL.COM", "ADMIN", "AQAAAAIAAYagAAAAEHBIr0C7tuo/6BdbOYX1LKrOnq3+XF04F4r4DSITcljPZ9cPM7ogQYttYRLWlc0gQw==", null, false, "3b1b9e84-e507-47f5-99de-bd44f79f6e51", false, "Admin" });
